    ...
    <div className="w-full bg-white text-black">
      ...
      <section className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <article>
            <div className="aspect-[16/9] bg-neutral-50 mb-6 overflow-hidden">
            ...
            <p className="uppercase tracking-widest text-[11px] font-medium text-neutral-400 mb-4">Case Study</p>
            <h2 className="text-2xl font-light mb-4">Sofitel and Air Aroma's Custom Fragrance Products</h2>
            <p className="text-neutral-500 font-light text-[15px] leading-relaxed">
          ...
          <article>
            ...
            <p className="uppercase tracking-widest text-[11px] font-medium text-neutral-400 mb-4">Industry Insights</p>
