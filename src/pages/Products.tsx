      ...
      <section className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <Link to="/fragrances" className="group">
             <div className="aspect-square bg-[#111] mb-6 overflow-hidden">
             ...
             <p className="text-white/50 font-light text-[15px]">Our collection of signature scents for luxury spaces.</p>
          </Link>
          <Link to="/diffusers" className="group">
             ...
             <p className="text-white/50 font-light text-[15px]">State-of-the-art cold air diffusion technology.</p>
          </Link>
          <Link to="/essential-oils" className="group">
             ...
             <p className="text-white/50 font-light text-[15px]">100% pure and natural essential oil blends.</p>
          </Link>
        </div>
      </section>
    </div>
